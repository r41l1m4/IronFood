...
public class Delivery {
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name = "complement", column = @Column(name = "sender_complemet")),
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name = "complement", column = @Column(name = "recipient_complemet")),
    ...
    public void editPreflightDetails(PreflightDetails details) {
        verifyIfCanBeEdited();
    ...
    private void verifyIfCanBePlaced() {
        if(!isFilled() || !getStatus().equals(DeliveryStatus.DRAFT)) {
    ...
    @Builder
    @AllArgsConstructor
    public static class PreflightDetails {
        private ContactPoint sender;
        private ContactPoint recipient;
        private BigDecimal distanceFee;
        private BigDecimal courierPayout;
